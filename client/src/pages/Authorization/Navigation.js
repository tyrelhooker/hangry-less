  ...
  <div className="navbar-fixed">
    <nav>
      <div className="nav-wrapper green">
        <a href= {routes.MAIN} className="brand-logo pulse"><img src="./images/logo12.png" className="responsive-img" alt=""/></a>
...
const NavigationNonAuth = (authUser) => (
  <div className="navbar-fixed">
    <nav>
      <div className="nav-wrapper green">
        <a href= {routes.MAIN} className="brand-logo"><img src="./images/logo12.png" className="responsive-img" alt=""/></a>
        <ul className="right hide-on-med-and-down">
          <NavItem to={routes.RECIPES} name="Recipes" />
          <NavItem to={routes.MY_PANTRY} name="My Pantry" />
          <NavItem to={routes.GROCERY_LIST} name="Grocery List" /> 
