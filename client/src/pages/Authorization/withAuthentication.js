...
//Framework around the higher order component which will handle the sessions logic (i.e. the apps state of being of being either authenticated or not).
